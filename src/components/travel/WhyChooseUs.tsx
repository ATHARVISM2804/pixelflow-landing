...
const WhyChooseUs = () => {
	return (
		<section className="py-20 bg-gradient-to-b from-gray-900 via-gray-950 to-black">
			<div className="container mx-auto px-4">
				<div className="text-center mb-16">
					...
					<p className="text-lg text-gray-300 max-w-2xl mx-auto">
						Trusted by thousands for fast, reliable, and professional ID
						solutions. We're not just a tool — we're your digital partner.
					</p>
				</div>
				...
				<div className="grid md:grid-cols-3 gap-8">
					{features.map((feature, index) => (
						<Card
							key={index}
							className="p-8 text-center bg-gray-900 border border-indigo-900/40 hover:border-indigo-500/60 transition-all duration-300 hover:shadow-lg"
						>
							<div className="w-16 h-16 mx-auto mb-6 rounded-full bg-indigo-900 flex items-center justify-center">
