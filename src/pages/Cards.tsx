        ...
        <header className="flex h-16 items-center justify-between px-6 bg-gray-900/50 backdrop-blur-xl border-b border-gray-800/50">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold text-white">All Free Cards</span>
            </div>
          </div>
              ...
              <Link key={card.id} to={card.path}>
                <Card className="bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 hover:border-gray-700/50 transition-all hover:shadow-lg hover:shadow-indigo-500/10 cursor-pointer group">
                  <CardContent className="p-6 text-center space-y-4">
                    {/* Icon Circle */}
                    <div className="w-20 h-20 mx-auto rounded-full bg-gray-800/50 flex items-center justify-center group-hover:scale-105 transition-transform">
