                ...
                <div className="border-2 border-dashed border-gray-700 rounded-lg p-8 text-center">
                  {selectedPdf ? (
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <p className="text-white font-medium">Drop your Ayushmaan PDF here or click to browse</p>
                        <p className="text-gray-400 text-sm">Supports PDF files with Ayushmaan cards up to 50MB</p>
                      </div>
                      <Button
                        onClick={triggerFileUpload}
                  ...
                  <div className="bg-gray-800/30 rounded-lg p-6 space-y-4">
                    ...
                    <div className="aspect-[2.1/1] bg-gray-800 rounded-lg overflow-hidden flex items-center justify-center">
                      ...
                      <div className="flex gap-4">
                        <img src={ayushmaanCards[0].image} alt="Ayushmaan Front" className="max-w-[45%] max-h-full object-contain rounded" />
