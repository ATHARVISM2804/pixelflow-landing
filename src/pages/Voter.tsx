...
export function Voter() {
  ...
  const downloadCombinedPdf = async (front: string, back: string, index: number) => {
    try {
      ...
      const link = document.createElement('a')
      link.href = url
      link.download = `voter_${index + 1}_combined.pdf`
      link.click()
      setTimeout(() => URL.revokeObjectURL(url), 100)
      toast({
        title: "PDF downloaded",
        description: "Combined Voter ID card PDF downloaded.",
      })
    } catch (error) {
      toast({
        title: "Error",
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="bg-gray-800/30 rounded-lg p-6 space-y-4">
                    ...
                    <div className="aspect-[1.6/1] bg-gray-800 rounded-lg overflow-hidden flex items-center justify-center">
                      <img src={voterCards[0].image} alt="Voter Front" className="max-w-full max-h-full object-contain" />
                    </div>
                    <Button
                      onClick={() => downloadImage(voterCards[0].image, `voter_front.png`)}
                      className="bg-indigo-500 text-white hover:bg-indigo-600"
                    >
                  ...
                  <div className="bg-gray-800/30 rounded-lg p-6 space-y-4">
                    ...
                    <div className="aspect-[1.6/1] bg-gray-800 rounded-lg overflow-hidden flex items-center justify-center">
                      <img src={voterCards[1].image} alt="Voter Back" className="max-w-full max-h-full object-contain" />
                    </div>
                    <Button
                      onClick={() => downloadImage(voterCards[1].image, `voter_back.png`)}
                  ...
                  <div className="bg-gray-800/30 rounded-lg p-6 space-y-4">
                    ...
                    <div className="aspect-[2.1/1] bg-gray-800 rounded-lg overflow-hidden flex items-center justify-center">
                      ...
                      <div className="flex gap-4">
                        <img src={voterCards[0].image} alt="Voter Front" className="max-w-[45%] max-h-full object-contain rounded" />
                        <img src={voterCards[1].image} alt="Voter Back" className="max-w-[45%] max-h-full object-contain rounded" />
                      </div>
                    </div>
                    <Button
                      onClick={() => downloadCombinedPdf(voterCards[0].image, voterCards[1].image, 0)}
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-xl font-bold text-white flex items-center gap-3">
                      ...
                      Card Preview - Voter {selectedCardIndex + 1}
                    </CardTitle>
                    <Button
                ...
                <CardContent>
                  <div className="space-y-6">
                    <div className="bg-gray-800 rounded-lg p-4 relative">
                      <img
                        src={voterCards[selectedCardIndex].image}
                        alt="Voter Preview"
